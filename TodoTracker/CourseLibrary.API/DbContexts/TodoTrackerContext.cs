...
namespace TT.Api.DbContexts;

public class TodoTrackerContext : DbContext
{
    public TodoTrackerContext(DbContextOptions<TodoTrackerContext> options)
       : base(options)
    {
    }
    ...
    public DbSet<TodoList> Authors { get; set; } = null!;
    public DbSet<TodoItem> Courses { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TodoList>().HasData(
            new TodoList("Berry", "Griffin Beak Eldritch", "Ships")
            {
                Id = Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                DateOfBirth = new DateTime(1980, 7, 23)
            },
            new TodoList("Nancy", "Swashbuckler Rye", "Rum")
            {
                Id = Guid.Parse("da2fd609-d754-4feb-8acd-c4f9ff13ba96"),
                DateOfBirth = new DateTime(1978, 5, 21)
            },
            new TodoList("Eli", "Ivory Bones Sweet", "Singing")
            {
                Id = Guid.Parse("2902b665-1190-4c70-9915-b9c2d7680450"),
                DateOfBirth = new DateTime(1957, 12, 16)
            },
            new TodoList("Arnold", "The Unseen Stafford", "Singing")
            {
                Id = Guid.Parse("102b566b-ba1f-404c-b2df-e2cde39ade09"),
                DateOfBirth = new DateTime(1957, 3, 6)
            },
            new TodoList("Seabury", "Toxic Reyson", "Maps")
            {
                Id = Guid.Parse("5b3621c0-7b12-4e80-9c8b-3398cba7ee05"),
                DateOfBirth = new DateTime(1956, 11, 23)
            },
            new TodoList("Rutherford", "Fearless Cloven", "General debauchery")
            {
                Id = Guid.Parse("2aadd2df-7caf-45ab-9355-7f6332985a87"),
                DateOfBirth = new DateTime(1981, 4, 5)
            },
            new TodoList("Atherton", "Crow Ridley", "Rum")
            {
        ...
        modelBuilder.Entity<TodoItem>().HasData(
           new TodoItem("Commandeering a Ship Without Getting Caught")
           {
           ...
           new TodoItem("Singalong Pirate Hits")
           {
