    ...
    public class MainDbContext : DbContext, IMainDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, FirstName = "Jordan", LastName = "Davila", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new User { Id = 2, FirstName = "Giovanni", LastName = "Krueger", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new User { Id = 3, FirstName = "Marjorie", LastName = "Nolan", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now });
